...
int makeFile(int t){
	...
	for(int i=1;i<=6;i++){
		for(int l=1;l<=t;l++){
			...
			std::string Astr = "/home/hry-user/StationFlow/AODV/data" +std::to_string(l)+ ".txt";
			std::string Ostr = "/home/hry-user/StationFlow/OLSR/data" +std::to_string(l)+ ".txt";
			std::string Gstr = "/home/hry-user/StationFlow/GPSR/data" +std::to_string(l)+ ".txt";
			std::string Istr = "/home/hry-user/StationFlow/IGPSR/data" +std::to_string(l)+ ".txt";
			std::string Pstr = "/home/hry-user/StationFlow/PGPSR/data" +std::to_string(l)+ ".txt";
			std::string Lstr = "/home/hry-user/StationFlow/LGPSR/data" +std::to_string(l)+ ".txt";
		...
		fstream fs;
		fs.open("/home/hry-user/StationFlow/"+value+".txt", ios::out);
