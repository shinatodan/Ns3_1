...
int makeFile(int t){
	...
	for(int i=1;i<=6;i++){
		for(int l=1;l<=t;l++){
			...
			std::string Astr = "/home/hry-user/UniversityFlow/AODV/data" +std::to_string(l)+ ".txt";
			std::string Ostr = "/home/hry-user/UniversityFlow/OLSR/data" +std::to_string(l)+ ".txt";
			std::string Gstr = "/home/hry-user/UniversityFlow/GPSR/data" +std::to_string(l)+ ".txt";
			std::string Istr = "/home/hry-user/UniversityFlow/IGPSR/data" +std::to_string(l)+ ".txt";
			std::string Pstr = "/home/hry-user/UniversityFlow/PGPSR/data" +std::to_string(l)+ ".txt";
			std::string Lstr = "/home/hry-user/UniversityFlow/LGPSR/data" +std::to_string(l)+ ".txt";
		...
		fstream fs;
		fs.open("/home/hry-user/UniversityFlow/"+value+".txt", ios::out);
