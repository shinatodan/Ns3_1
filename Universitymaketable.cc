...
int makeFile(int t){
	...
	for(int i=1;i<=6;i++){
		for(int l=1;l<=t;l++){
			...
			std::string Astr = "/home/hry-user/University/AODV/data" +std::to_string(l)+ ".txt";
			std::string Ostr = "/home/hry-user/University/OLSR/data" +std::to_string(l)+ ".txt";
			std::string Gstr = "/home/hry-user/University/GPSR/data" +std::to_string(l)+ ".txt";
			std::string Istr = "/home/hry-user/University/IGPSR/data" +std::to_string(l)+ ".txt";
			std::string Pstr = "/home/hry-user/University/PGPSR/data" +std::to_string(l)+ ".txt";
			std::string Lstr = "/home/hry-user/University/LGPSR/data" +std::to_string(l)+ ".txt";
		...
		fstream fs;
		fs.open("/home/hry-user/University/"+value+".txt", ios::out);
